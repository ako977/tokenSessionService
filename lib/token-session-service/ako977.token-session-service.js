    ...
    .provider('Ako977SessionService', function Ako977SessionServiceProvider() {
        ...
        this.$get = ['$window','$interval','$filter','localStorageService',
            function Ako977SessionServiceFactory($window, $interval, $filter, localStorageService) {
                ...
                Ako977SessionService.setCustomData = function(data, property) {
                    var obj;
                    if (property && property !== null) {
                        obj = Ako977SessionService.getCustomData();
                        if (!obj) { 
                            obj = {}; 
                        } else {
                            obj[property] = data;
                    ...
                    localStorageService.set(Ako977SessionService.config.customDataName, obj);
                };
                ...
                Ako977SessionService.init = function() {
                    ...
                    currentTimestamp = Date.parse(currentTimestamp.toUTCString());
                ...
                Ako977SessionService.monitor = function(args,$http) {
                    ...
                    Ako977SessionService.setCustomData(args.customData);            
